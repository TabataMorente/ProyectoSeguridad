...
<html lang="es">
    ...
    .fila {
      ...
      align-items: flex-start; /* 🔹 Evita que se centren verticalmente */
      gap: 20px;
      width: 1100px;
    }
    ...
    .container {
      ...
      flex: 0 0 400px; /* 🔹 Tamaño fijo opcional para evitar saltos */
...
if ($result === false) {
    ...
    echo "<p style='text-align:center; font-family:Arial; font-size:18px; color:#555; margin-top:50px;'>
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        echo "<h3><strong> Apuesta número " . htmlspecialchars($row['id_apuesta']) . "</strong></h3>";
